...
class ImplDailyReportPermissionsRepository
    implements IDailyReportPermissionsRepository {
  final ProviderRef ref;

  ImplDailyReportPermissionsRepository({required this.ref});
  ...
  Future<List<DailyReportPermissionView>> getDailyReportPermissions(
    ...
    final uri =
        Uri.parse('${ENV.backendUrl}/daily-reports/$dailyReportId/permissions');
    ...
    return jsonResponse
        .map((e) => DailyReportPermissionView.fromJson(e))
        .toList();
  }
}
